        ...
        initializeAuth: async () => {
          ...
          try {
            ...
            if (!auth || !auth.getSession) {
              throw new Error('Supabase auth client not properly initialized');
            }
            ...
            try {
              // Add a timeout wrapper for getSession
              ...
              const response = await getSessionWithTimeout();
              ...
              if (error.name === 'AbortError') {
                sessionError = new Error('Authentication timeout - please check your internet connection');
              } else {
                sessionError = error;
              }
            }
